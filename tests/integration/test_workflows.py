...
class TestShoppingCartWorkflow:
    ...
    def test_shopping_cart_workflow(
        self, authenticated_client, test_user, product, product_2
    ):
...
class TestOrderManagementWorkflow:
    ...
    def test_order_management_workflow(
        self, authenticated_client, test_user, order, product
    ):
...
class TestErrorHandlingWorkflow:
    ...
    def test_cart_workflow_with_out_of_stock_product(
    ...
    def test_order_workflow_with_invalid_address(
        self, authenticated_client, test_user, product
    ):
...
class TestPerformanceWorkflow:
    ...
    def test_cart_performance_with_many_items(
        self, authenticated_client, test_user, category
    ):
