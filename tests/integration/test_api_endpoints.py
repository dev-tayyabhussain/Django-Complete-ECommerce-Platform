...
from store.models import Product, Category, ProductTag, Cart, CartItem, Order, OrderItem
...
class TestWishlistAPI:
    ...
    def test_wishlist_list_api_authenticated(self, authenticated_api_client, test_user, product):
...
class TestOrderAPI:
    ...
    def test_order_list_api_authenticated(self, authenticated_api_client, test_user, order):
    ...
    def test_order_detail_api_authenticated(self, authenticated_api_client, test_user, order):
    ...
    def test_order_create_api(self, authenticated_api_client, test_user, product, address, payment_method):
...
class TestAPIErrorHandling:
    ...
    def test_cart_add_item_api_invalid_quantity(self, authenticated_api_client, product):
    ...
    def test_order_create_api_insufficient_stock(self, authenticated_api_client, test_user, product, address, payment_method):
...
class TestAPIAuthentication:
    ...
    def test_public_endpoints_allow_unauthenticated_access(self, api_client, category, product):
...
class TestAPISerialization:
    ...
    def test_product_serialization(self, api_client, category, product, product_tag):
        ...
        required_fields = [
            ...
            "stock_quantity", "is_in_stock", "category", "tags", "main_image",
            "is_active", "is_featured", "is_bestseller", "view_count"
        ]
