...
class TestNewUserJourney:
    ...
    def test_new_user_complete_journey(
        self, selenium_driver, live_server_url, category, product
    ):
        ...
        add_to_cart_btn = driver.find_element(
            By.CSS_SELECTOR, "button[data-action='add-to-cart']"
        )
...
class TestReturningUserJourney:
    ...
    def test_returning_user_journey(
        self, selenium_driver, live_server_url, test_user, category, product
    ):
        ...
        wishlist_btn = driver.find_element(
            By.CSS_SELECTOR, "button[data-action='add-to-wishlist']"
        )
        wishlist_btn.click()
        ...
        quantity_input = driver.find_element(
            By.CSS_SELECTOR, "input[data-action='update-quantity']"
        )
        quantity_input.clear()
...
class TestProductBrowsingJourney:
    ...
    def test_product_browsing_journey(
        self, selenium_driver, live_server_url, category, product, product_tag
    ):
        ...
        category_filter = driver.find_element(
            By.CSS_SELECTOR, f"a[href*='category={category.slug}']"
        )
...
class TestMobileResponsiveJourney:
    ...
    def test_mobile_responsive_journey(
        self, selenium_driver, live_server_url, category, product
    ):
...
class TestErrorHandlingJourney:
    ...
    def test_error_handling_journey(
        self, selenium_driver, live_server_url, test_user, product
    ):
...
class TestAccessibilityJourney:
    ...
    def test_accessibility_journey(
        self, selenium_driver, live_server_url, category, product
    ):
        ...
        username_label = driver.find_element(
            By.CSS_SELECTOR, "label[for='id_username']"
        )
        assert username_label.is_displayed()

        password_label = driver.find_element(
            By.CSS_SELECTOR, "label[for='id_password']"
        )
