...
from store.models import (
    Category, Product, ProductTag, ProductReview, Wishlist,
    ...
    def handle(self, *args, **options):
        ...
        products_data = [
            ...
            },
            {
                ...
                'stock_quantity': 18,
                'category': categories[0],  # Electronics
                'tags': [tags[0], tags[1], tags[6]],  # New Arrival, Best Seller, Premium
                'is_featured': True,
                'is_bestseller': True,
            ...
            },
            {
                ...
                'stock_quantity': 35,
                'category': categories[0],  # Electronics
                'tags': [tags[0], tags[4], tags[6]],  # New Arrival, Limited Edition, Premium
                'is_featured': True,
                'is_bestseller': False,
            ...
            },
            {
                ...
                'stock_quantity': 12,
                'category': categories[0],  # Electronics
                'tags': [tags[0], tags[6], tags[4]],  # New Arrival, Premium, Limited Edition
                'is_featured': True,
                'is_bestseller': True,
        ...
        self.stdout.write('2. Login as test user (username: testuser, password: testpass123)')
        ...
        for user in users:
            ...
            address_data = [
                ...
                },
                {
                    ...
                    'city': random.choice(['Boston', 'Seattle', 'Denver', 'Miami', 'Atlanta']),
