...
def update_cart_item(request, item_id):
    ...
    try:
        ...
        cart_total_items = cart.get_total_items()
        cart_total_price = cart.get_total_price_with_currency()
        item_total_price = cart_item.get_total_price_with_currency() if cart_item.quantity > 0 else '$0.00'
...
class CartListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if context['cart_subtotal'] >= shipping_threshold:
            ...
            context['shipping_remaining'] = shipping_threshold - context['cart_subtotal']
        ...
        # Calculate total
        context['order_total'] = context['cart_subtotal'] + context['shipping_cost'] + context['tax_amount']
    ...
    try:
        if 'applied_coupon' in request.session:
            ...
            return JsonResponse({
                ...
                'cart_total_price': get_or_create_cart(request).get_total_price_with_currency()
            })
        else:
            return JsonResponse({
                'success': False,
