...
from .models import (
    Product, Category, ProductTag, ProductImage, 
...
class TagSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_active', 'created_at', 'product_count', 'url'
        ]
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'display_price', 'is_on_sale', 'discount_percentage',
            'stock_quantity', 'is_in_stock', 'is_low_stock',
            'category', 'tags', 'main_image', 'main_image_url',
            'is_featured', 'is_bestseller', 'view_count',
...
class ProductDetailSerializer(ProductSerializer):
    ...
    class Meta(ProductSerializer.Meta):
        fields = ProductSerializer.Meta.fields + [
            'description', 'additional_images', 'review_stats',
    ...
    def get_review_stats(self, obj):
        ...
        if reviews.exists():
            return {
                ...
                'average_rating': round(reviews.aggregate(
                    avg_rating=serializers.Avg('rating')
                )['avg_rating'], 1),
...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProductReview
        fields = [
            'id', 'product', 'product_name', 'user', 'rating', 'rating_display',
            'title', 'comment', 'is_verified_purchase', 'is_approved',
            'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'user', 'product', 'is_verified_purchase', 'is_approved',
            'created_at', 'updated_at'
        ]
...
class CategoryDetailSerializer(CategorySerializer):
    ...
    class Meta(CategorySerializer.Meta):
        fields = CategorySerializer.Meta.fields + [
            'subcategories', 'featured_products'
        ]
