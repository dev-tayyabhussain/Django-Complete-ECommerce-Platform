...
from .models import UserProfile, Address, PaymentMethod, Cart, CartItem
from .forms import (
    CustomUserCreationForm, CustomAuthenticationForm, 
    UserProfileForm, AddressForm, PaymentMethodForm
)
...
class ProfileSetupView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            logger.info(f"Profile setup completed for user: {self.request.user.username}")
...
class ProfileDetailView(LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['payment_methods'] = self.request.user.payment_methods.filter(is_active=True)
