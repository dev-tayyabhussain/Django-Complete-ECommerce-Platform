...
urlpatterns = [
    ...
    path('categories/<slug:slug>/', api_views.CategoryDetailAPIView.as_view(), name='category_detail_api'),
    path('categories/<slug:slug>/products/', api_views.CategoryProductsAPIView.as_view(), name='category_products_api'),
    
    # Tag API endpoints
    path('tags/', api_views.TagListAPIView.as_view(), name='tag_list_api'),
    path('tags/<slug:slug>/', api_views.TagDetailAPIView.as_view(), name='tag_detail_api'),
    path('tags/<slug:slug>/products/', api_views.TagProductsAPIView.as_view(), name='tag_products_api'),
    
    # Search API endpoints
    path('search/', api_views.ProductSearchAPIView.as_view(), name='search_api'),
    path('search/suggestions/', api_views.SearchSuggestionsAPIView.as_view(), name='search_suggestions_api'),
    
    # Review API endpoints
    path('products/<slug:slug>/reviews/', api_views.ProductReviewsAPIView.as_view(), name='product_reviews_api'),
    ...
    path('wishlist/add/<int:product_id>/', api_views.AddToWishlistAPIView.as_view(), name='add_to_wishlist_api'),
    path('wishlist/remove/<int:product_id>/', api_views.RemoveFromWishlistAPIView.as_view(), name='remove_from_wishlist_api'),
    ...
    path('cart/update/<int:item_id>/', api_views.UpdateCartItemAPIView.as_view(), name='update_cart_item_api'),
    path('cart/remove/<int:item_id>/', api_views.RemoveFromCartAPIView.as_view(), name='remove_from_cart_api'),
    ...
    path('orders/<int:pk>/', api_views.OrderDetailAPIView.as_view(), name='order_detail_api'),
    ...
    path('payment-methods/', api_views.PaymentMethodListAPIView.as_view(), name='payment_method_list_api'),
    
    # Analytics and statistics
    path('stats/products/', api_views.ProductStatsAPIView.as_view(), name='product_stats_api'),
    path('stats/categories/', api_views.CategoryStatsAPIView.as_view(), name='category_stats_api'),
