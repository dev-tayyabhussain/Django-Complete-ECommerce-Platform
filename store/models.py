...
class Product(models.Model):
    ...
    """
    # Basic Information
    name = models.CharField(max_length=200, help_text="Product name (max 200 characters)")
    slug = models.SlugField(max_length=200, unique=True, blank=True, help_text="URL-friendly product identifier")
    description = models.TextField(help_text="Detailed product description")
    short_description = models.CharField(max_length=500, blank=True, help_text="Brief product summary")
    ...
    is_in_stock = models.BooleanField(default=True, help_text="Product availability status")
    low_stock_threshold = models.PositiveIntegerField(
        default=5,
        help_text="Stock level to trigger low stock alerts"
    )
    ...
    is_bestseller = models.BooleanField(default=False, help_text="Bestseller product status")
    
    # SEO and Analytics
    meta_title = models.CharField(max_length=60, blank=True, help_text="SEO meta title")
    meta_description = models.CharField(max_length=160, blank=True, help_text="SEO meta description")
    view_count = models.PositiveIntegerField(default=0, help_text="Product view counter")
...
class ProductTag(models.Model):
    ...
    description = models.TextField(blank=True)
    color = models.CharField(max_length=7, default='#007bff', help_text="Tag color in hex format")
    is_active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class ProductReview(models.Model):
    ...
    is_verified_purchase = models.BooleanField(default=False, help_text="Verified purchase status")
